...
import React, { useContext, useState } from 'react'; // Corrected the import statement
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <div className='flex items-center gap-6'>
        ...
        <img onClick={() => setVisible(true)} src={assets.menu_icon} className='w-5 cursor-pointer small:hidden' alt="Menu Icon" />
      </div>
